...
Faire fonctionner (avec l'api en local) :
  ...
  3- dans le repertoire src/app/shared/ ouvrir le fichier assignment.service.ts :
      1- commenter le ligne  uri = "https://projet-angular-backend.onrender.com/api/assignments"; (17eme ligne du fichier)
      2- décommenter le ligne  uri =  //uri = "http://localhost:8010/api/assignments"; (16eme ligne du fichier)
